                                ...
                                {filteredStudents.length === 0 ? (
                                    ...
                                    <tr key={student.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/30'}>
                                        ...
                                        {(() => {
                                            ...
                                            const rateColor = rateNum >= 90 ? 'text-green-600' : rateNum >= 80 ? 'text-yellow-600' : 'text-red-600';
                                            const subColor = rateNum >= 90 ? 'text-green-500' : rateNum >= 80 ? 'text-yellow-500' : 'text-red-500';
                                            return (
